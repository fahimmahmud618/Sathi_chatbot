...
import "./Home.css";
import chatpic from "./asset/chat.png"
import servicepic from "./asset/service.png"
    ...
    <div className="bodyhome">
      ...
      <div className="d2">
        <center>
          ...
          গুরুত্বপুর্ণ নাগরিক সেবা<br />
            <img className="logoicon1" src={servicepic} alt="Chat" />
          ...
          <div className="second_section">
            <a href="/chat">
            <div className="aaa gotochat">
              
                <div className="row d-flex justify-content-center ">
                  <p className="hometitle">সাথী এ-আই চ্যাট <br />
                  <img className="logoicon1" src={chatpic} alt="Chat" />
